...
#SBATCH -t 00:03:00            # Time limit (10 minutes for debugging purposes)
...
python scripts/overfit.py --arch segformer --cityscapes_root "/hkfs/work/workspace/scratch/ma_nilbecke-thesis/data/cityscapes" \
